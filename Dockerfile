...
WORKDIR /opt
RUN ls -all
RUN curl -LO https://corretto.aws/downloads/latest/amazon-corretto-11-x64-linux-jdk.tar.gz && tar -xvf amazon-corretto-11-x64-linux-jdk.tar.gz && rm amazon-corretto-11-x64-linux-jdk.tar.gz
RUN ls -all
